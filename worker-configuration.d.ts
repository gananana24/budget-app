/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bdf92d8ed375da8257f48b0efdfe84c5)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/backend/worker/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "DATABASE_URL">> {}
}
